// [claude-code 2026-04-15] T8: Provider tree + lazy-loaded tab router + polished transitions
...
function AuthenticatedApp() {
  ...
  return (
    <MobileShell activeTab={activeTab} onTabChange={handleTabChange}>
      {/* Chat stays mounted with display:none — streams survive navigation */}
      <Suspense fallback={<LazyFallback />}>
        <ChatPage visible={activeTab === 2} />
      </Suspense>
