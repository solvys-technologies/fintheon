# Sprint Brief: S32-T8 — Browser-Harness Integration + Voice Orb Wiring + Omi Sidebar Chat Takeover
...
- [ ] Log every invocation to a new `browser_harness_audit` table:
  ...
  ```
  Migration file: `backend-hono/migrations/037_browser_harness_audit.sql`.
...
- [ ] Changelog entry
- [ ] `// [claude-code 2026-04-23] S32-T8 browser-harness + voice orb + sidebar takeover`
...
3. Migration `037_browser_harness_audit.sql`; hand to TP.
...
```
[v5.23.0] feat: S32-T8 browser-harness tool + voice orb toggle + Omi sidebar takeover
```
