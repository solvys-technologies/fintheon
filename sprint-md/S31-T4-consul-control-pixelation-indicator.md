# Sprint Brief: S31-T4 — Consul Control Pixelation Indicator
...
`s31-harper-2-1` (runs parallel with T2 + T3 after T1 merges)
...
```
[v5.23.0] feat: S31-T4 Consul Control pixelation corners (replace solid overlay)
```
