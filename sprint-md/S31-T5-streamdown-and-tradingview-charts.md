# Sprint Brief: S31-T5 — Streamdown Chat Renderer + TradingView Lightweight Charts
...
- [ ] Changelog entry
- [ ] `// [claude-code 2026-04-23] S31-T5 streamdown + TV charts` on modified files
...
```
[v5.23.0] feat: S31-T5 streamdown chat renderer + TradingView lightweight charts
```
