...
{activeTab === 'chat' && (
  <div className="ml-auto flex items-center gap-1.5">
    <button title="Run Report"><Scroll className="w-3.5 h-3.5" /></button>
    <button title="New Chat"><Plus className="w-3.5 h-3.5" /></button>
    <button title="History"><Clock className="w-3.5 h-3.5" /></button>
  </div>
)}
```
