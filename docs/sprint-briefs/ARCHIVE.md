...
- T3: Commentator infrastructure
- T4: Historical calibration DB + upload context
- T5: IV Scorer V3 regime-aware rewire
- T6: Developer settings overhaul + password gate
...
- T3: Frontend KPI rewrites + interpretation layer
...
- T3: KPI trading lingo + interpretation + briefing display
- T3b: Research card + highlight system
- T4: Connections + AI wiring
...
- T3: Cards modal autoseed / reconciler state machine
- T4: Market impact pipeline / ProjectX service wiring
...
- T7: Ask Harp + Claude CLI (Harper-Opus) integration (+ AMEND)
...
- T3: Dashboard redesign + NarrativeMap fix + econ intelligence + Sanctum cleanup
- T4: Chat interface + boardroom agents + slide-out panels + apparatus polish
- T5: Conversation history + take note memory flush
- T5-T1: Ropes fix (urgent)
- T5-T2: Sanctum filter + legend panel
- T5-T3: Hierarchical zoom system
