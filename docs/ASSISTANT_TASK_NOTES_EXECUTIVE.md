...
- **Chatroom backend moved off 8080** (Fintheon backend owns 8080) to avoid conflicts.
  - `Priced In Capital/chatroom-backend/config.json` → port **8090**
- **Fintheon Executive views added inside Fintheon**:
...
See `docs/FINTHEON_EXECUTIVE_LOCAL.md`.
