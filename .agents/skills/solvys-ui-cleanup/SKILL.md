...
Load `/solvys-feels` and `.Codex/skills/solvys-feels/reference/design-guidelines.md` before proposing changes. External references are thinking inputs only. Do not add dependencies, copy component code, import assets, or use TP-vetoed references.
