...
Junior types `/solvys-brief-alt <brief_id>` in their VSCode Codex pane. The brief_id comes from TP via the coworking bridge -- it will already be posted in the junior's thread by the time they run this.
