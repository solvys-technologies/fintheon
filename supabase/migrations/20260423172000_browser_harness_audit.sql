...
--   supabase migration repair --status applied 20260423172000
-- can locate a file at glob supabase/migrations/20260423172000_*.sql.
-- If you need the real DDL for disaster recovery, query:
--   select statements from supabase_migrations.schema_migrations where version = '20260423172000';
