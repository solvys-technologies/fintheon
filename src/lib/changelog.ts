...
export const changelog: ChangelogEntry[] = [
  ...
  },
  {
    ...
    files: [
      ...
      "frontend/hooks/useharper-2_1VoiceSession.ts",
      "frontend/hooks/useVoiceAssistant.ts",
      "frontend/contexts/ERContext.tsx",
      ...
      "frontend/components/performance/PerformanceChatButton.tsx",
      ".gitignore",
      "supabase/migrations-pending/20260424000000_rename_omi_tables_to_harper_2_1_voice.sql",
      "package.json",
      "scripts/fintheon-update.sh",
      "src/lib/changelog.ts",
    ],
