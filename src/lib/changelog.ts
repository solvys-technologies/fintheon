...
export const changelog: ChangelogEntry[] = [
  ...
  },
  {
    ...
    agent: "codex",
    summary:
      "Corrected sprint numbering so S100+ is a post-beta/deferred lane instead of the active chronology, renumbered App Store readiness from S120 to S84 and Infisical/Portless security infra from S121 to S85, and updated local agent guidance plus sprint taxonomy docs to prevent max-S drift.",
    files: [
      "AGENTS.md",
      "WORKSPACE.md",
      "CLAUDE.md",
      ".cursor/rules/project-standards.md",
      ".agents/skills/solvys-brief/SKILL.md",
      ".agents/skills/solvys-orchestrate/SKILL.md",
      ...
      "sprint-md/S83-SHASHANK-SHIPPING-RESET.md",
      "sprint-md/S84-ORCH-ios-developer-enrollment.md",
      "sprint-md/S84-T1-app-information-content-rights.md",
      "sprint-md/S84-T2-privacy-policy-app-privacy.md",
      "sprint-md/S84-T3-pricing-availability.md",
      "sprint-md/S84-T4-build-selection-gap-audit.md",
      "sprint-md/S84-T5-review-submission-preflight.md",
      "sprint-md/S85-BRIEF-infisical-portless-security-infra.md",
      "src/lib/changelog.ts",
    ],
  },
  {
  ...
  },
  {
    ...
    agent: "codex",
    summary:
      "Added standalone public Privacy Policy and Terms of Use pages for the Fintheon website, linked them from the landing prototype footer, styled the legal layout against the existing marketing surface, and created the S84 App Store review-readiness sprint docs.",
    files: [
      "frontend/fintheon-landing-prototype.html",
  ...
  {
    date: "2026-05-29T10:58:00-04:00",
    agent: "codex",
    summary:
      "SOL-236 NarrativeFlow runtime repair: opener submissions now send as real chat turns with immediate user bubbles and deterministic acknowledgements, first-turn thinking text stays visible, NarrativeFlow data tools populate the real Research rail, LangGraph checkpoint scaffolding was added behind a backend flag, MainContent header popups render through a shared overlay host, and Forum header/rim-glow polish was applied.",
    files: [
      ...
      "frontend/components/layout/MainContentOverlayHost.tsx",
      ...
      "frontend/components/narrative/narrative-rail-preview.ts",
      "frontend/components/narrative/useNarrativeAgentActions.ts",
      "backend-hono/src/services/langgraph/narrativeflow-agent-graph.ts",
      ...
      "backend-hono/package-lock.json",
      "backend-hono/.env.example",
      "frontend/components/proxvoice/ProxVoiceForum.tsx",
  ...
  },
  {
    ...
    agent: "codex",
    summary:
      "Hotfix: mobile surface routing now keeps phones on the mobile PWA, daily briefs reject empty/provider-error output and stay visible until 7:50AM SystemOS local time, Arbitrum skips all-unavailable verdicts, Chamber digest text is cleaned/rendered through Streamdown, and selected Arbitrum presets put the header action into Run mode while bypassing the revision-check shortcut.",
    files: [
      "shared/surface-routing.ts",
      "backend-hono/src/services/brief-validation.ts",
      "backend-hono/src/services/brief-generator.ts",
      "backend-hono/src/routes/data/index.ts",
      "frontend/components/desk/DeskDailyBriefingPanel.tsx",
      "backend-hono/src/services/arbitrum/degraded-verdict.ts",
      ...
      "frontend/components/arbitrum/digest-text.ts",
  ...
  },
  {
    ...
    agent: "codex",
    summary:
      "S102 first vertical slice: NarrativeFlow opener/handoff prompts now become visible composer drafts instead of hidden initial chat turns, PIC macro event-risk cognition is loaded into agent and brief prompts, Desk Plan forecast rows render PIC internal forecast/miss/beat/confidence/cycle fields, Arbitrum runs receive a seven-day headwind/tailwind risk packet, Public.com is registered as a read-only backend market-data provider with Streamdown source attribution, and FileRoom now exposes manager-gated forecasting-model edits with versioned writes.",
    files: [
      "frontend/components/ChatInterface.tsx",
      ...
      "backend-hono/src/services/ai/agent-instructions/macro-event-cognition.ts",
      "backend-hono/src/services/econ-forecast/econ-forecast-service.ts",
      "backend-hono/src/services/econ-forecast/econ-forecast-redeliberation.ts",
      "backend-hono/src/types/day-plan.ts",
      "frontend/types/day-plan.ts",
      ...
      "frontend/components/narrative/DayCard.tsx",
      "backend-hono/src/services/arbitrum/risk-context.ts",
      "backend-hono/src/services/arbitrum/engine.ts",
      "backend-hono/src/services/arbitrum/seats.ts",
      "backend-hono/src/services/arbitrum/facilitator.ts",
      "backend-hono/src/services/arbitrum/event-trigger.ts",
      "backend-hono/src/services/arbitrum/verdict-store.ts",
      "supabase/migrations/20260527102000_arbitrum_risk_context.sql",
      "backend-hono/src/services/market-data/public-provider.ts",
      ...
      "frontend/lib/services/file-room.ts",
      "index.html",
      "src/lib/changelog.ts",
    ],
  },
  ...
  },
  {
    ...
    agent: "codex",
    summary:
      "v7.0.5 release prep: captured post-v7.0.4 icon/runtime hotfixes and refreshed package plus install/update pointers for deploy.",
    files: [
      "package.json",
      "backend-hono/package.json",
      "mobile/package.json",
