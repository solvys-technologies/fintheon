...
export const changelog: ChangelogEntry[] = [
  ...
  },
  {
    ...
    agent: "codex",
    summary:
      "v7.0.4 release hotfix: sealed the macOS app bundle during DMG packaging, made deployed DMG verification mount and codesign-check the downloaded app, and refreshed setup/update pointers so nontechnical installs receive the repaired package.",
    files: [
      "package.json",
      ...
      ".agents/skills/solvys-deploy/SKILL.md",
      "src/lib/changelog.ts",
    ],
  },
  {
  ...
  },
  {
    ...
    agent: "codex",
    summary:
      "v7.0.4 release prep: captured the new app toast notification surfaces and in-app desktop updater path, then refreshed setup/update script pointers for the patch release.",
    files: [
  ...
  },
  {
    ...
    agent: "codex",
    summary:
      "v7.0.2 deploy prep: captured NarrativeFlow workspace-session fixes, Desk prototype polish, app-init retry recovery, and refreshed install/update pointers for the v7 patch release.",
    files: [
      "package.json",
      "mobile/package.json",
      "scripts/fintheon-setup.sh",
  ...
  },
  {
    ...
    files: [
      ...
      "frontend/components/desk/DeskBriefingPanel.tsx",
      "frontend/components/desk/DeskPlanWidget.tsx",
      "frontend/components/desk/DeskRiskSignalsPanel.tsx",
      "frontend/components/desk/DeskSprintMapCalendar.tsx",
  ...
  },
  {
    ...
    agent: "codex",
    summary:
      "v6.7.26 deploy captures uncommitted NarrativeFlow/Harper toolkit work: surface routing, approval-gated edits, restored map language, sandbox rehearsal, and release installer pointers.",
    files: [
      "package.json",
      "mobile/package.json",
      "scripts/fintheon-setup.sh",
  ...
  {
    date: "2026-05-25T09:20:15-04:00",
    agent: "codex",
    summary:
      "Expanded Harper's NarrativeFlow toolkit across sandbox and production: Strands now exposes surface-open, internal-data, and approval-gated edit tools; chat cognition streams route NarrativeFlow actions into Workspace/DeskMap/Forecasts surfaces; approved edits can update workspace artifacts or save Desk Forecast drafts; and the HTML sandbox now demos the same tool contract without silently mutating before approval.",
    files: [
      "backend-hono/src/services/strands/chat-ui-tools.ts",
      "backend-hono/src/services/strands/narrativeflow-chat-tools.ts",
      "backend-hono/src/services/chat-ui-action-store.ts",
      "backend-hono/src/services/ai/soul/harper.md",
      "frontend/components/chat/hooks/useChatUiActions.ts",
      "frontend/components/chat/ChatSidebar.tsx",
      "frontend/components/narrative/NarrativeCanvas.tsx",
      "frontend/components/narrative/useNarrativeAgentActions.ts",
      "frontend/components/narrative/DeskForecastsView.tsx",
      "frontend/lib/narrative-session-api.ts",
      "frontend/sandbox/narrativeflow/mock-agent.ts",
      "frontend/sandbox/narrativeflow/mock-api.ts",
      "frontend/sandbox/narrativeflow/mock-agent-toolkit.ts",
      "src/lib/changelog.ts",
    ],
  },
  {
    date: "2026-05-25T02:20:08-04:00",
    agent: "codex",
    summary:
      "Wired the NarrativeFlow HTML sandbox for Energy & Infrastructure Crisis rehearsal: mock RiskFlow/session data now centers grid stress, AI power demand, transformer bottlenecks, utilities, gas infrastructure, and project finance; the sandbox Harper mock streams chat responses, opens the to-do drawer, asks approval questions, opens the right rail with workspace data, and applies an active workspace title/artifact edit for crisis-framing turns.",
    files: [
      "frontend/sandbox/narrativeflow/mock-agent.ts",
      "frontend/sandbox/narrativeflow/mock-api.ts",
      "frontend/sandbox/narrativeflow/mock-data.ts",
      "src/lib/changelog.ts",
    ],
  },
  {
    date: "2026-05-24T19:05:00-04:00",
    agent: "codex",
    summary:
      "Restored NarrativeFlow Map toward the old territory-map language: active desk narratives now render as color-bounded bubbles with matching catalyst-card borders, archived sessions are hidden from the active map and grouped in a collapsible session-rail archive, delete/archive management uses a confirmation modal, DeskMap cover imagery now behaves like a Notion-style cover with inline change/remove controls and local drag focus, the Map now lives as an expandable tab inside the NarrativeFlow right rail, and the Consilium analysis dropdown stays above the workspace without reintroducing the black toolbar strip.",
    files: [
      "frontend/components/narrative/DeskMap.tsx",
      "frontend/components/narrative/NarrativeCanvas.tsx",
      "frontend/components/narrative/NarrativeDeskMapCanvas.tsx",
      "frontend/components/narrative/NarrativeWorkDrawer.tsx",
      "frontend/components/narrative/NarrativeSessionDrawer.tsx",
      "frontend/components/narrative/NarrativeSessionManageModal.tsx",
      "frontend/components/narrative/NarrativeSessionWorkspace.tsx",
      "frontend/components/narrative/NarrativeSessionHistory.tsx",
      "frontend/components/narrative/narrative-desk-map-utils.ts",
      "frontend/lib/narrative-session-api.ts",
      "frontend/index.css",
      "src/lib/changelog.ts",
    ],
  ...
  {
    date: "2026-05-24T18:38:44-04:00",
    agent: "codex",
    summary:
      "Fixed NarrativeFlow Analysis dropdown layout regression. Shared popover chrome now preserves absolute/fixed positioning so dropdowns do not expand the Consilium toolbar, the Analysis menu is capped to a compact scrollable surface, and the Consilium header collapses labels on mobile so the map/menu controls stay inside the viewport.",
    files: [
      "frontend/components/consilium/ConsiliumHub.tsx",
      "frontend/components/consilium/NarrativeAnalysisDropdown.tsx",
      "frontend/components/narrative/NarrativeCanvas.tsx",
      "frontend/index.css",
      "src/lib/changelog.ts",
    ],
  ...
  {
    date: "2026-05-24T18:14:00-04:00",
    agent: "codex",
    summary:
      "NarrativeFlow motion sweep: all relevant chat shells, composer drawers, @mention and attachment drawers, session history drawer, floating canvas toolbar, workspace ReactFlow canvas, legacy force canvas, and DeskMap canvas now carry Solvys transition hooks for fade, panel reveal, node/edge entrance, button lift, chip motion, and reduced-motion fallbacks.",
    files: [
  ...
  {
    date: "2026-05-24T17:58:00-04:00",
    agent: "codex",
    summary:
      "NarrativeFlow old/new merge pass: the workspace map now renders linked catalysts with the old RiskFlow/Narrative research-card anatomy, IV category cards are restored above the workspace and open the Research Rail against their linked catalyst, the rail's Flow and Timeline tabs reuse the old catalyst card format, and the Analysis dropdown/workspace panels/cards/buttons/media get a fade/microinteraction pass.",
    files: [
      "frontend/components/feed/RiskFlowCardAnatomy.tsx",
      "frontend/components/consilium/NarrativeAnalysisDropdown.tsx",
      "frontend/components/narrative/NarrativeCanvas.tsx",
      "frontend/components/narrative/NarrativeFlowTab.tsx",
      "frontend/components/narrative/NarrativeIvCardDeck.tsx",
      "frontend/components/narrative/NarrativeLinkedCatalystCard.tsx",
      "frontend/components/narrative/NarrativeSensemakingMap.tsx",
      "frontend/components/narrative/NarrativeTimelineTab.tsx",
      "frontend/components/narrative/NarrativeWorkDrawer.tsx",
      "frontend/components/narrative/sensemaking-catalyst-adapter.ts",
      "frontend/index.css",
      "src/lib/changelog.ts",
    ],
  },
  {
    date: "2026-05-24T17:42:00-04:00",
    agent: "codex",
    summary:
      "Consilium/NarrativeFlow rail pass: Sanctum now shows the active subview icon/label, Workspace/Forecasts/Coliseum/Resolved/Map live in the Analysis dropdown with polished transitions, Chart splits NarrativeFlow beside TradingView, Desk rail icons match the dashboard people icon, map import opens the composer RiskFlow drawer without cutting the input, the duplicate under-input Sessions popover is gone, map pan/zoom/multi-select/filter/heatmap controls are wired, dead Add Catalyst/Highlight controls are removed, placeholder forecast states are borderless and centered, and DeskMap uploads accept the frontend's 8 MB image contract.",
    files: [
      ...
      "frontend/components/narrative/NarrativeInputBar.tsx",
      "frontend/components/narrative/NarrativeSessionWorkspace.tsx",
      "frontend/components/narrative/narrative-surface-options.ts",
      "frontend/components/narrative/DeskForecastsView.tsx",
      "frontend/components/narrative/DeskMap.tsx",
      "frontend/index.css",
      "src/lib/changelog.ts",
  ...
  {
    date: "2026-05-24T16:22:19-04:00",
    agent: "codex",
    summary:
      "File Room hardening pass: category document groups are now real collapsible chevron cards, the document reader renders cleaned body text through Streamdown, File Room replaces the old SOUL-only apparatus surface, File Room memo/chart/agent documents are available to global @mentions, and the 17:00 CAO loop runs the agentic analysis block into Desk Inbox approvals.",
    files: [
      ...
      "frontend/components/consilium/ConsiliumHub.tsx",
      "frontend/components/consilium/ConsiliumTabConfig.ts",
      "frontend/components/desk/DeskInboxFeed.tsx",
      "frontend/components/desk/DeskRail.tsx",
      "frontend/components/memory/FileRoomDetailPane.tsx",
      "frontend/components/memory/FileRoomPanel.tsx",
      "frontend/components/memory/FileRoomSectionList.tsx",
      "frontend/components/memory/file-room-format.ts",
      "frontend/lib/context-mentions.ts",
      "src/lib/changelog.ts",
    ],
  },
  {
    date: "2026-05-24T16:05:00-04:00",
    agent: "codex",
    summary:
      "v6.7.25 polishes the CAO final face and NarrativeFlow greeting spacing, adds File Room and Desk Inbox beta plumbing, and keeps File Room runtime markdown out of release commits.",
    files: [
      ".gitignore",
      "backend-hono/src/routes/chart-evidence/index.ts",
      "backend-hono/src/routes/desk-inbox/index.ts",
      "backend-hono/src/routes/file-room/index.ts",
      "backend-hono/src/routes/index.ts",
      "backend-hono/src/services/agentic-analysis-block/index.ts",
      "backend-hono/src/services/context-mentions/mention-sources.ts",
      "backend-hono/src/services/desk-inbox/index.ts",
      "backend-hono/src/services/file-room/index.ts",
      "frontend/components/chat/ContextMentionDrawer.tsx",
      "frontend/components/consilium/ConsiliumHub.tsx",
      "frontend/components/desk/DeskInboxFeed.tsx",
      "frontend/components/desk/DeskRail.tsx",
  ...
  },
  {
    ...
    agent: "codex",
    summary:
      "v6.7.21 beta unifies the repo-owned chat composer, connected drawers, Harper chat UI tools, official DeepSeek provider control, approved icon-bank facade, and catalyst-bank/Obsidian vault foundation for NarrativeFlow workspace sessions.",
    files: [
      "package.json",
      "mobile/package.json",
      "scripts/fintheon-cli.sh",
      ...
      "scripts/fintheon-update.sh",
      "frontend/components/chat/composer/RepoChatComposer.tsx",
      "frontend/components/chat/composer/KILL_LIST.md",
      "frontend/components/chat/FintheonComposer.tsx",
      "frontend/components/ui/chatgpt-prompt-input.tsx",
      "frontend/components/chat/FintheonAttachPopup.tsx",
      "frontend/components/chat/FintheonProviderTrigger.tsx",
      "frontend/components/chat/FintheonProviderModal.tsx",
      "frontend/components/icons/DeepSeekWhaleIcon.tsx",
      "frontend/components/chat/CognitionPanel.tsx",
      "frontend/components/chat/TodoDrawer.tsx",
      "frontend/components/chat/ChatQuestionApprovalDrawer.tsx",
      "frontend/components/chat/ChatAnswerStreamWidget.tsx",
      "frontend/components/chat/ChatDrawerPeek.tsx",
      "frontend/components/chat/hooks/useChatUiActions.ts",
      "frontend/components/chat/hooks/useAutoCollapseDrawer.ts",
      "frontend/components/icon-bank/iconifyBodies.ts",
      "frontend/components/icon-bank/AnimatedIcons.tsx",
      "frontend/components/icon-bank/ChatCitationIcon.tsx",
      "frontend/components/icon-bank/DotMatrixLoader.tsx",
      "backend-hono/src/services/strands/chat-ui-tools.ts",
      "backend-hono/src/services/chat-ui-action-store.ts",
      "backend-hono/src/routes/harper/ui-actions.ts",
      "backend-hono/src/routes/narrative/catalyst-bank.ts",
      "backend-hono/src/services/narrative-sessions/catalyst-bank.ts",
      "backend-hono/scripts/export-riskflow-catalysts-obsidian.ts",
      "supabase/migrations/20260523203000_narrative_user_catalyst_bank.sql",
      "frontend/index.css",
      "mobile/index.css",
      "src/lib/changelog.ts",
    ],
  ...
  {
    date: "2026-05-23T18:47:00-04:00",
    agent: "codex",
    summary:
      "Corrected the icon implementation to use the exact SVG bodies from icon-bank-preview.html instead of approximate local redraws. Added a vendored preview-body bank, routed lucide-react facade exports to the approved Tabler/Phosphor/Iconoir/Radix/Lucide glyphs at preview default sizing, patched Feucht/Consul/Arbitrum/Antilag one-off surfaces, and kept chat citation symbols on the same approved icon set. Desktop and mobile typecheck/build pass.",
    files: [
      "frontend/components/icon-bank/iconifyBodies.ts",
      "frontend/components/icon-bank/AnimatedIcons.tsx",
      "frontend/components/icon-bank/ChatCitationIcon.tsx",
      "frontend/components/icon-bank/DotMatrixLoader.tsx",
      "frontend/components/icons/ArbitrumGlyph.tsx",
  ...
  {
    date: "2026-05-23T19:25:00-04:00",
    agent: "codex",
    summary:
      "Icon, loader, Zen, and splash pass: completed the approved local icon-bank mappings, targeted IV and Forum/Arbitrum/agent swaps, added persisted Zen appearance state, slowed and recolored dot-matrix loaders, and enforced the three-second login globe acceleration before auth handoff.",
    files: [
      "frontend/components/icon-bank/AnimatedIcons.tsx",
      "frontend/components/icon-bank/DotMatrixLoader.tsx",
      "frontend/components/icons/ArbitrumGlyph.tsx",
      ...
      "frontend/components/consilium/ConsiliumTabConfig.ts",
      "frontend/components/consilium/AgentBadge.tsx",
      "frontend/components/consilium/AgentLounge.tsx",
      ...
      "frontend/index.css",
      "frontend/public/dot-matrix/",
      "mobile/public/dot-matrix/",
      "src/lib/changelog.ts",
    ],
  },
  {
    date: "2026-05-23T19:05:00-04:00",
    agent: "codex",
    summary:
      "S82 chat UI tool bridge: gave Harper callable tools for the chat to-do drawer, issue-typed work items, right-rail plan briefs, and composer-sized approval questions with Streamdown answer widgets.",
    files: [
      "backend-hono/src/services/strands/chat-ui-tools.ts",
      "backend-hono/src/services/chat-ui-action-store.ts",
      "backend-hono/src/routes/harper/ui-actions.ts",
  ...
  {
    date: "2026-05-23T18:20:00-04:00",
    agent: "codex",
    summary:
      "S83 visual overhaul: aliased lucide-react to a local Its Hover-inspired animated icon facade, vendored dot/matrix loader SVGs for desktop and mobile, routed legacy spinners through circular dot/matrix loaders, added local isometric chat citation icons, assigned chat/Arbitrum/Econ/Desk loader variants, and rebuilt login/splash around the rotating globe sequence.",
    files: [
      "frontend/components/icon-bank/AnimatedIcons.tsx",
      "frontend/components/icon-bank/DotMatrixLoader.tsx",
      "frontend/components/icon-bank/ChatCitationIcon.tsx",
  ...
  {
    date: "2026-05-23T13:20:00-04:00",
    agent: "codex",
    summary:
      "Beta packaging hygiene: confirmed the packaged renderer HTML was valid after a clean relaunch and hardened the local build-release installer to stop any running Fintheon process before replacing /Applications/Fintheon.app, preventing stale ASAR handles from rendering binary garbage.",
    files: ["scripts/build-release.sh", "src/lib/changelog.ts"],
  },
  {
    date: "2026-05-23T12:00:00-04:00",
    agent: "codex",
    summary:
      "S80 Coliseum foundation: added desk profile and style storage, manager/owner publish guards, Desk Forecast draft/publish records with read-only prediction-market references, a rule-based thesis monitor, Harper/Oracle Desk Style preflight injection, and the private-beta NarrativeFlow Desk Forecasts toggle shell.",
    files: [
      "supabase/migrations/20260523120000_coliseum_desk_core.sql",
      "backend-hono/src/services/coliseum/types.ts",
      "backend-hono/src/services/coliseum/db.ts",
      "backend-hono/src/services/coliseum/desks.ts",
      "backend-hono/src/services/coliseum/permissions.ts",
      "backend-hono/src/services/coliseum/profiles.ts",
      "backend-hono/src/services/coliseum/agent-style.ts",
      "backend-hono/src/services/coliseum/forecasts.ts",
      "backend-hono/src/services/coliseum/thesis-monitor.ts",
      "backend-hono/src/services/desk-context/preflight.ts",
      "backend-hono/src/routes/coliseum/index.ts",
      "backend-hono/src/routes/index.ts",
      "frontend/lib/coliseum-api.ts",
      "frontend/components/narrative/DeskForecastsView.tsx",
      "frontend/components/narrative/NarrativeCanvas.tsx",
  ...
  {
    date: "2026-05-23T03:35:00-04:00",
    agent: "codex",
    summary:
      "Weekly Desk Plan and intelligence loop pass: Econ Calendar queue can send a 7-day catalyst table into CAO chat, Streamdown now renders static chat markdown, weekly approval tools, native macro ticker mentions with hover cards and 7-day gradient sparklines, approved queue events sync back into Desk Plans, Sprint Map defaults to the next populated desk window, glass surfaces were enriched across modals/toasts/popovers/sprint cards, and agent prompts now inject a TradingView macro watchlist plus stronger reflection/backtest rules.",
    files: [
      "frontend/lib/desk-week-plan.ts",
      "frontend/components/econ/TradingViewCalendar.tsx",
      "frontend/components/chat/AssistantMessagePrimitive.tsx",
      "frontend/components/chat/parts/TextPart.tsx",
      "frontend/components/chat/slots/StreamdownChat.tsx",
      "frontend/components/chat/slots/WeeklyDeskPlanSlot.tsx",
      "frontend/components/chat/slots/MarketTickerStripSlot.tsx",
      "frontend/components/chat/slots/MarketTickerCard.tsx",
      "frontend/components/chat/slots/MarketTickerMention.tsx",
      "frontend/components/chat/slots/market-ticker-types.ts",
      "frontend/components/chat/TickerMentionPopup.tsx",
      "frontend/components/chat/FintheonSkillsPopup.tsx",
      "frontend/components/chat/McpConnectorPopup.tsx",
      "frontend/components/DeskPlanPlannerToastBridge.tsx",
      "frontend/components/arbitrum/ChamberAgentSummaryPopup.tsx",
      "frontend/components/proxvoice/DraggableProfilePopup.tsx",
  ...
  },
  {
    ...
    files: [
      ...
      "scripts/setup.ts",
      "scripts/update.ts",
      "scripts/vproxy-anthropic-oauth.sh",
  ...
  {
    date: "2026-05-15T15:08:00-04:00",
    agent: "claude-code",
    summary:
      "S66 Release Suite v6.2.1: instrument expansion + per-instrument IV scoring, multi-week Desk Plan with TWT + pre-session pricing, macOS lockout permissions + themed LockScreen overlay + Lock til Desk Session, @dnd-kit drag-and-drop toolbar with frosted-glass preview + vertical FadingRuler pill bar separators, chat overhaul with collapsible iOS-style tool call cards + Nothing braille 2x2 block spinner + global RichTextRenderer (**bold**). All builds clean (tsc + vite), all curl smoke tests pass.",
    files: [
      ...
      "electron/preload.cjs",
      "frontend/components/LockScreen.tsx",
      "frontend/components/layout/ToolbarDnD.tsx",
      "frontend/components/shared/RichTextRenderer.tsx",
      "frontend/components/narrative/DayCard.tsx",
      ...
      "frontend/components/layout/NavSidebar.tsx",
      "frontend/components/TraderNametag.tsx",
      "frontend/components/chat/parts/ToolCallPart.tsx",
      "frontend/components/chat/parts/TextPart.tsx",
      "frontend/components/chat/parts/ReasoningPart.tsx",
      "frontend/components/chat/CognitionPanel.tsx",
      "frontend/components/chat/primitive/BrailleSpinner.tsx",
      "frontend/components/settings/BlockerTab.tsx",
      "frontend/components/settings/TradingTab.tsx",
      "frontend/components/SettingsPanel.tsx",
      "frontend/components/arbitrum/ArbitrumChamber.tsx",
  ...
  },
  {
    ...
    agent: "codex",
    summary:
      "S65 unification and closed-beta validation: reconciled settings platform defaults, Desk Plan lockout policy, runtime Peer Chat removal, header/sidebar chrome polish, shell-style terminal behavior, background updater readiness, and Risk Signal freshness metadata/card polish.",
    files: [
      "frontend/contexts/SettingsContext.tsx",
      "frontend/components/settings/IframesTab.tsx",
      "frontend/components/settings/BlockerTab.tsx",
      "frontend/components/settings/TradingTab.tsx",
      "frontend/utils/day-plan-lockout.ts",
      "frontend/hooks/useLockout.ts",
      "backend-hono/src/services/lockout.ts",
      "backend-hono/src/routes/lockout/index.ts",
      "frontend/components/narrative/DayCard.tsx",
      ...
      "frontend/lib/version-check.ts",
      "backend-hono/src/services/riskflow/risk-signal-generator.ts",
      "backend-hono/src/services/riskflow/risk-signal-types.ts",
      "backend-hono/src/routes/riskflow/handlers.ts",
      "frontend/components/narrative/RiskSignalCards.tsx",
      "frontend/components/narrative/risk-signal-card-utils.ts",
      "scripts/fintheon-install-update.sh",
      "scripts/fintheon-update.sh",
      "package.json",
      "src/lib/changelog.ts",
  ...
  },
  {
    ...
    agent: "codex",
    summary:
      "S61 shipped: agent governance, SOUL fileroom, and Chamber/RiskFlow context controls unified. Archived to sprint-changelog/.",
    files: ["sprint-changelog/S61-ORCHESTRATION.md"],
  },
  {
