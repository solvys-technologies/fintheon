...
- Purge visible Omi references and connector entries. Rename allowed residual voice/backend references to Harper Voice/Harper-2.1 only when safe; DB column migrations can remain pending if coordinated separately.
