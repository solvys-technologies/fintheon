...
:root {
  ...
  --fintheon-glass-bg: color-mix(
    in srgb,
    var(--fintheon-surface) 55%,
    transparent
  );
  --fintheon-glass-border: color-mix(
    in srgb,
    var(--fintheon-accent) 16%,
    transparent
  );
  --fintheon-glass-highlight: color-mix(
    in srgb,
    var(--fintheon-accent) 6%,
    transparent
  );
...
:root {
  ...
  --bg-modifier-active: rgba(199, 159, 74, 0.1);
  ...
  /* Borders */
  --border-base: rgba(199, 159, 74, 0.1);
  --border-hover: rgba(199, 159, 74, 0.2);
  --border-focus: rgba(199, 159, 74, 0.4);

  /* Scrollbar */
  --scrollbar-thin-thumb: rgba(199, 159, 74, 0.2);
...
:root {
  ...
  --accent: oklch(0.72 0.1 75); /* #c79f4a */
  --surface: oklch(0.1 0.01 70); /* #0a0905 */
