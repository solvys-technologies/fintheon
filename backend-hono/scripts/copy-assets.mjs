...
// [claude-code 2026-04-20] Rewritten from bun/TS to pure Node ESM — the prod
// Docker image runs node:20-alpine and doesn't ship bun, which was failing the
// build at `bun scripts/copy-assets.ts`. Node runs .mjs natively.
//
