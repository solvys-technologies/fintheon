...
import type { QuickFintheonRequest, QuickFintheonResult } from '../../../types/quick-fintheon.js'
...
export async function handleQuickFintheon(c: Context): Promise<Response> {
  const body = await c.req.json<QuickFintheonRequest>().catch(() => ({} as QuickFintheonRequest))
