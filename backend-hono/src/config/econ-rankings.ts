...
export const ECON_PRINT_RANKINGS: EconPrintConfig[] = [
  {
    ...
    blackoutSeconds: 120,
    impact: "high",
    chainRole: "What's coming off the docks. First signal.",
    rank: 1,
  },
  {
    name: "PPI",
    blackoutSeconds: 120,
    impact: "high",
    chainRole: "Prices they're paying.",
    rank: 2,
  },
  {
    name: "CPI",
    blackoutSeconds: 120,
    impact: "very-high",
    chainRole: "Prices on the shelf. Core narrative pair with PPI.",
    rank: 2,
  },
  {
    name: "NFP",
    blackoutSeconds: 120,
    impact: "very-high",
    chainRole: "Jobs data. Major volatility catalyst.",
    rank: 3,
  },
  {
    name: "PCE",
    blackoutSeconds: 120,
    impact: "very-high",
    chainRole: "Fed's preferred inflation gauge. Chain endpoint.",
    rank: 4,
  },
  {
    name: "GDP",
    blackoutSeconds: 120,
    impact: "high",
    chainRole: "Macro confirmation. Less tradeable intraday.",
    rank: 5,
  },
  {
    name: "FOMC",
    blackoutSeconds: 120,
    impact: "very-high",
    chainRole: "Not a print but a regime-defining event.",
    rank: 6,
  },
  {
    name: "Jobless Claims",
    blackoutSeconds: 60,
    impact: "low",
    chainRole: "Secondary. Trade only if conditions ideal.",
    rank: 7,
  },
  {
    name: "Retail Sales",
