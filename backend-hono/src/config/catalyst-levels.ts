...
export const CATALYST_LEVEL_CRITERIA = {
  4: {
    ...
    keywords: [
      'fed rate decision', 'rate cut', 'rate hike', 'fomc decision',
      'circuit breaker', 'flash crash', 'nuclear', 'strait of hormuz',
      'ceasefire', 'emergency declaration', 'presidential emergency',
      'cpi surprise', 'nfp surprise', 'gdp surprise'
    ],
  ...
  3: {
    ...
    keywords: [
      'fomc minutes', 'fed speaker', 'timiraos', 'tariff', 'sanction',
      'troop movement', 'oil supply', 'treasury secretary',
      'aapl earnings', 'nvda earnings', 'msft earnings', 'amzn earnings',
      'goog earnings', 'meta earnings', 'tsla earnings',
      'opec', 'pipeline closure', 'proxy attack'
    ],
  },
  2: {
    label: 'Medium',
    ...
    keywords: [
      'housing starts', 'consumer confidence', 'retail sales', 'durable goods',
      'presidential tweet', 'trump post', 'diplomatic', 'sector news',
      'deltone', 'fj commentary'
    ],
  },
  1: {
    label: 'Low',
    ...
    keywords: [
      ...
      'non-us', 'political', 'corporate news', 'product launch'
    ],
  },
} as const;
