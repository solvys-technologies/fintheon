...
import { assignMacroLevel, type MacroLevelInput } from '../utils/assign-macro-level.js';
...
test('assignMacroLevel unit table', () => {
  const cases: Array<{ name: string; input: Partial<MacroLevelInput>; expected: 1 | 2 | 3 | 4 }> = [
    {
    ...
    },
    {
      ...
      input: { keywordMatches: ['fomc minutes'], ivScore: 75, urgencySignals: 2, riskType: 'Macro' },
      expected: 3,
    },
    {
    ...
    },
    {
      ...
      input: { keywordMatches: ['housing starts'], ivScore: 50, riskType: 'Macro' },
      expected: 2,
    },
    {
