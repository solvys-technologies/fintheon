// [claude-code 2026-04-25] S40-P1: extracted from services/voice-tts.ts; kept as
// the cloud fallback for Piper. Same shape as the previous module so callers
// only need to swap import paths.
//
// Configure:
...
const log = createLogger("VoiceTTS:ElevenLabs");
