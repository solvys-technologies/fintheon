...
export const IMMUTABLE_RULES: ImmutableRule[] = [
  // ── Banned Personalities (podcasters, pundits, provocateurs) ──────────
  {
    ...
    reason:
      "Non-financial political provocateurs. Zero relevance to market analysis.",
  ...
  },
  {
    ...
    reason:
      "Podcaster opinions do not move markets and degrade feed signal-to-noise ratio.",
    immutable_since: "2026-04-30",
  },
  ...
  // ── Banned Language Patterns ──────────────────────────────────────────
  {
    ...
    reason:
      "Vague, directionless language that confuses severity classification.",
    immutable_since: "2026-04-30",
  },
  {
    ...
    reason:
      "Advertising and platform promos have no place in the RiskFlow feed.",
    immutable_since: "2026-04-30",
  },
  ...
  // ── Source Policy (NEVER revert) ──────────────────────────────────────
  {
    ...
    reason:
      "MSM noise degrades RiskFlow precision. Per TP directive: approved sources are FRED, BLS, Federal Reserve, FinancialJuice, DeItaOne only.",
  ...
  },
  {
    ...
    reason:
      "Speculation-filter prevents 'reportedly', 'sources say', 'could trigger' noise from inflating IV scores.",
  ...
  // ── Content Quality Gates (NEVER remove) ──────────────────────────────
  {
    ...
    reason:
      "Professional trading platform. Zero tolerance for non-market content.",
  ...
  // ── Score Integrity ───────────────────────────────────────────────────
  {
    ...
    reason:
      "IV without VIX context inflates severity during calm markets and understates risk during volatility.",
  ...
  // ── Autonomous Task Routing ───────────────────────────────────────────
  {
    ...
    reason:
      "Harper autonomous subprocess loop is deprecated per 2026-04-17. Claude Code Routines drive Harper Ops; DeepSeek drives feed-quality autonomous tasks.",
    immutable_since: "2026-04-30",
  },
];
