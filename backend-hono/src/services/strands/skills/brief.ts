...
export const solvysBriefTool = tool({
  name: "solvys_brief",
  description:
    "Generate a self-contained task brief for handing off to a fresh Claude Code instance. Includes context, goals, constraints, and file references.",
  inputSchema: z.object({
    task: z
      .string()
      .describe("What the brief is for — the task or feature to hand off"),
    files: z
      .array(z.string())
      .optional()
      .describe("Key file paths to include as context"),
    constraints: z
      .string()
      .optional()
