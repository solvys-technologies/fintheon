...
export const solvysOrchestrateTool = tool({
  ...
  description:
    "Orchestrate parallel Claude Code instances for large features. Splits work into tracks, generates briefs, and monitors execution.",
  inputSchema: z.object({
      ...
      .array(
        z.object({
          ...
          files: z
            .array(z.string())
            .optional()
            .describe("Key files for this track"),
        }),
      )
    ...
    maxParallel: z
      .number()
      .optional()
      .describe("Max parallel tracks (default 3)"),
  }),
