...
const VERTICAL_FADING_RULER: React.CSSProperties = {
  width: 1,
  alignSelf: "stretch",
  background: "linear-gradient(to bottom, rgba(199,159,74,0.18), transparent 80%)",
};
    ...
    <div style={{ marginTop: 12 }}>
      ...
      <div style={{ display: "flex", alignItems: "center", gap: 16, flexWrap: "wrap" }}>
        <span style={{ display: "flex", alignItems: "center", gap: 8 }}>
          ...
          <span style={{ ...METRIC_VALUE, color: leak_sentinel.rejected_non_allowlisted > 0 ? "#ef4444" : "var(--fintheon-text)" }}>
        ...
        <span style={{ display: "flex", alignItems: "center", gap: 8 }}>
          ...
          <span style={{ ...METRIC_VALUE, color: leak_sentinel.unexpected_feed_insertions > 0 ? "#ef4444" : "var(--fintheon-text)" }}>
            {leak_sentinel.unexpected_feed_insertions}
          </span>
        </span>
      </div>
      {leak_sentinel.last_leak_detail && (
        <div style={{ marginTop: 4, fontSize: 9, fontFamily: "var(--font-mono)", color: "#ef4444", opacity: 0.7 }}>
      ...
      <div style={{ display: "flex", alignItems: "center", gap: 16, flexWrap: "wrap" }}>
        <span style={{ display: "flex", alignItems: "center", gap: 8 }}>
          ...
          <span style={{ ...METRIC_VALUE, color: continuity.econ_stalled ? "#ef4444" : "var(--fintheon-text)" }}>
            {continuity.econ_received}/{continuity.econ_expected}
          </span>
          <span style={{ fontSize: 9, color: continuity.econ_stalled ? "#ef4444" : "var(--fintheon-muted)" }}>
        ...
        <span style={{ display: "flex", alignItems: "center", gap: 8 }}>
          ...
          <span style={{ ...METRIC_VALUE, color: continuity.commentary_stalled ? "#ef4444" : "var(--fintheon-text)" }}>
            {continuity.commentary_received}/{continuity.commentary_expected}
          </span>
          <span style={{ fontSize: 9, color: continuity.commentary_stalled ? "#ef4444" : "var(--fintheon-muted)" }}>
