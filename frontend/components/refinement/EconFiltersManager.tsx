        ...
        <div className="space-y-1.5 p-2 rounded border border-zinc-800 bg-zinc-900/50">
          <div className="flex gap-1.5">
            <select
              ...
              className="flex-1 bg-transparent border border-zinc-700 rounded px-1.5 py-1 text-[10px] text-[var(--fintheon-text)] outline-none"
            >
            ...
            <select
              ...
              className="flex-1 bg-transparent border border-zinc-700 rounded px-1.5 py-1 text-[10px] text-zinc-300 outline-none"
            >
