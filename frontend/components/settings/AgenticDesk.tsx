          ...
          >
            <div className="flex items-start gap-3.5 mb-4">
              ...
              <div className="flex-1 min-w-0 pt-0.5">
                <span className="text-[14px] font-semibold text-white truncate block">{cao.name}</span>
                <span
            ...
            <div className="flex items-end gap-2">
              <div className="flex-1">
                <label className="block text-[11px] font-medium text-gray-500 mb-1">CAO Name</label>
                <input
                  type="text"
                  value={caoName}
                  onChange={(e) => setCaoName(e.target.value)}
                  onKeyDown={(e) => { if (e.key === 'Enter') handleSaveCaoName(); }}
