    ...
    <div className="flex items-center justify-center py-20">
      ...
      >
        <div
          ...
          style={{ backgroundColor: 'color-mix(in srgb, var(--fintheon-accent) 12%, transparent)' }}
        >
          <Lock size={18} style={{ color: 'var(--fintheon-accent)' }} />
        </div>

        <h3 className="text-[15px] font-semibold text-white mb-1">Developer Settings</h3>
        <p className="text-xs text-gray-500 mb-6">Enter password to access developer tools.</p>
