    ...
    >
      {enabled ? (
        ...
        <div
          ...
          style={{ width: compact ? '24px' : '28px', height: compact ? '24px' : '28px', backgroundColor: 'var(--fintheon-surface)', border: '1.5px solid var(--fintheon-accent)' }}
        >
          <MicOff className="w-3 h-3" style={{ color: 'var(--fintheon-muted)' }} />
        </div>
      )}
    </button>
  );
