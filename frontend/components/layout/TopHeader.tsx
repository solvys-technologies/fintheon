...
export function TopHeader({
  ...
  return (
    <div
      ...
      className={`relative bg-[var(--fintheon-surface)] flex items-center justify-between px-3 border-t fintheon-accent-border-top ${topStepXEnabled && layoutOption === "tickers-only" ? "h-[47px]" : "h-[50px]"}`}
    >
