...
export function HotHandBanner({ hoursRemaining, winAmount, onDismiss }: HotHandBannerProps) {
  return (
    <div className="flex items-center gap-2 px-3 py-1.5 bg-[var(--fintheon-accent)]/5 border-b border-[var(--fintheon-accent)]/15">
      <AlertTriangle size={11} className="text-[var(--fintheon-accent)] shrink-0" />
      ...
      <span className="text-[7px] font-mono text-[var(--fintheon-accent)]/30 shrink-0">C4</span>
      {onDismiss && (
        <button
          onClick={onDismiss}
