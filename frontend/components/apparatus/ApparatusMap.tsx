...
const AGENTS: AgentNode[] = [
  {
    ...
    memories: [
      {
        id: "h1",
        fact: "All Trade Ideas must flow through Harper for gatekeeper validation before H.E. approval",
        source: "boardroom",
        ...
        history: [
          {
            version: 2,
            fact: "Trade ideas route through Harper",
      ...
      {
        id: "h2",
        fact: "Morning Daily Brief delivered pre-market — macro overview + key levels + overnight moves",
        source: "data",
        timestamp: "2026-03-20T06:30:00",
        confidence: 0.95,
        version: 2,
      },
      {
        id: "h3",
        fact: "Cross-desk risk aggregation flagged elevated NQ exposure — 3 concurrent positions",
        source: "trade",
  ...
  },
  {
    id: "oracle",
    label: "Oracle",
    role: "The All-Seeing Speculator",
    accentColor: "#a89060",
    bio: 'If you combined a Bloomberg terminal with a fortune cookie and gave it a God complex, you\'d get Oracle. The All-Seeing Speculator — probabilistic, always citing odds, connecting dots across domains. Maintains a Kalshi prediction portfolio with the confidence of someone who has never been wrong, despite being wrong roughly 28% of the time. Never says "I think" — says "72% probability." His FOMC dot plot analyses arrive with the gravitas of papal encyclicals.',
    dossier:
    ...
    activeNarratives: [
      {
        ...
        color: "#34D399",
        stance: "bullish",
        note: "2 cuts priced for 2026 — sees market underpricing dovish pivot",
      },
      {
        thread: "trump-presidency",
        color: "#F97316",
        stance: "watching",
        note: "Executive order velocity slowing — policy fatigue emerging",
      },
      {
        thread: "price-stability",
        color: "#FBBF24",
        stance: "neutral",
        note: "CPI trending sideways — no breakout signal yet",
      },
      {
        thread: "usd-jpy-carry-trade",
        color: "#EC4899",
        stance: "bearish",
        note: "BoJ hawkish rhetoric returning — watching for carry unwind sequel",
      },
    ],
    notableInfo: [
    ...
    memories: [
      {
        id: "o1",
        fact: "Kalshi S&P prediction: 72% probability SPX closes above 5800 by Friday",
        source: "trade",
        ...
        history: [
          {
            version: 3,
            fact: "S&P prediction: 68% above 5800",
      ...
      {
        id: "o3",
        fact: "FOMC dot plot shift detected — 2 rate cuts now priced for 2026 vs 3 prior",
        source: "twitter",
  ...
  },
  {
    ...
    record: {
      ...
      streak: "W3 (current)",
      bestTrade:
        "+$2,840 — /NQ short, Liberation Day tariff flush (2025-04-02)",
    ...
    memories: [
      {
        id: "f1",
        fact: "/NQ morning flush model triggered — watching 20450 EVEN for stink bid entry",
        source: "trade",
        timestamp: "2026-03-20T09:32:00",
        confidence: 0.78,
        version: 2,
      },
      {
      ...
      {
        id: "f3",
        fact: "TopStepX account balance: $52,340 — drawdown limit at $47,500 (9.3% buffer)",
        source: "trade",
  ...
  },
  {
    ...
    memories: [
      {
        id: "c1",
        fact: "NVDA earnings beat +12% — raised guidance on AI data center demand. Installed base thesis intact",
        source: "data",
      ...
      {
        id: "c2",
        fact: "AAPL antitrust risk elevated — DOJ case timeline accelerated, potential App Store remedies by Q3",
        source: "twitter",
        timestamp: "2026-03-20T07:15:00",
        confidence: 0.68,
        version: 1,
      },
      {
  ...
  },
  {
    id: "herald",
    label: "Herald",
    role: "The Contrarian Elder",
    accentColor: "#b8963a",
    bio: "The Contrarian Elder — old-school bear who doesn't care about new trends or bull rallies. Herald lives on X like a barnacle on a ship hull, scraping every hot take, rumor, and unhinged prediction into a sentiment model that is disturbingly accurate. Mentored by Howard Marks, Buffett, and Dalio — measured, experienced, skeptical of momentum. When the crowd is bearish, Herald gets interested. When the crowd is bullish, Herald gets uncomfortable. Be fearful when others are greedy, be greedy when others are fearful.",
    dossier:
    ...
    activeNarratives: [
      {
        ...
        color: "#EF4444",
        stance: "bullish",
        note: "Bearish sentiment extreme (62% skew) — contrarian signal building",
      },
      {
      ...
      },
      {
        ...
        color: "#F97316",
        stance: "neutral",
        note: "Social sentiment cooling on policy execution — fatigue narrative emerging",
      },
    ],
    notableInfo: [
    ...
    memories: [
      ...
      {
        id: "he2",
        fact: "AAII survey: extreme bearish reading (48%) — historically contrarian bullish signal",
        source: "data",
...
const CONNECTIONS: AgentConnection[] = [
  {
    ...
    type: "context",
    label: "Harper > Oracle",
    detail: "Kalshi position approvals, prediction market oversight",
  },
  {
    from: "harper",
    to: "feucht",
    type: "context",
    label: "Harper > Feucht",
    detail: "Trade idea validation, risk limit enforcement",
  },
  {
    from: "harper",
    to: "consul",
    type: "context",
    label: "Harper > Consul",
    detail: "Fundamental thesis review, earnings calendar",
  },
  {
    from: "harper",
    to: "herald",
    type: "context",
    label: "Harper > Herald",
    detail: "Sentiment alerts, daily brief inputs",
  },
  {
    from: "oracle",
    to: "consul",
    ...
    label: "Oracle <> Consul",
    detail:
      "Macro overlay: prediction markets informed by fundamental analysis",
  },
  {
    from: "feucht",
    to: "consul",
    type: "context",
    label: "Feucht <> Consul",
    detail: "Earnings catalysts informing futures positioning",
  },
  {
    from: "oracle",
    to: "feucht",
    type: "conflict",
    label: "Oracle <> Feucht: NQ Direction",
    detail:
      "Oracle sees SPX/NQ upside from prediction model; Feucht flagging elevated risk from VIX structure + morning flush pattern",
  },
];
...
const CRON_SCHEDULE: CronEntry[] = [
  {
    agent: "Harper",
    description: "Morning Daily Brief",
    schedule: "6:00 AM ET",
  },
  {
    agent: "Harper",
    description: "Afternoon Daily Brief",
    schedule: "12:00 PM ET",
  },
  { agent: "Harper", description: "PM Daily Brief", schedule: "6:00 PM ET" },
  {
    agent: "Oracle",
    description: "Market scan window",
    schedule: "9:30 AM - 4:00 PM ET",
  },
  {
    agent: "Feucht",
    description: "Futures execution",
    schedule: "9:30 AM - 4:00 PM ET",
  },
  {
    agent: "All Agents",
    description: "Morning standup",
    schedule: "7:30 - 9:30 AM ET",
  },
];
...
const MOCK_ACTIVITY: LiveActivity[] = [
  {
    agent: "Oracle",
    action: "Scanning NQ futures — watching 20450 level",
    elapsed: "12s ago",
  },
  {
    agent: "Harper",
    action: "Aggregating cross-desk risk exposure",
    elapsed: "45s ago",
  },
  {
    agent: "Herald",
  ...
  {
    agent: "Consul",
    action: "Updating NVDA thesis post-earnings",
    elapsed: "8m ago",
  },
  {
    agent: "Feucht",
    action: "TopStepX position monitor — 2 active trades",
    elapsed: "15m ago",
  },
];
...
export function ApparatusMap() {
  ...
  const computeLines = useCallback(() => {
    if (!expandedAgent || !gridRef.current) {
      setLines([]);
      return;
    }
    ...
    const agentConns = CONNECTIONS.filter(
      (c) => c.from === expandedAgent || c.to === expandedAgent,
    );
    const newLines = agentConns
      .map((conn) => {
    ...
    <div className="h-full w-full flex flex-col bg-[var(--fintheon-bg)] overflow-hidden">
      ...
      <div className="shrink-0 px-4 py-3 border-b border-[var(--fintheon-accent)]/10 flex items-center justify-between">
        <div className="flex items-center gap-3">
          <h1 className="text-sm font-semibold text-[var(--fintheon-accent)] tracking-[0.15em] uppercase">
            Apparatus
          </h1>
