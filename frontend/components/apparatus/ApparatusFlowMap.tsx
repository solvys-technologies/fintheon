...
const AGENTS: AgentNode[] = [
  {
    id: "harper",
    label: "Harper",
    role: "CAO — Chief Approval Officer",
    accentColor: "#D4AF37",
    memories: [
      {
        id: "h1",
        fact: "All Trade Ideas must flow through Harper for gatekeeper validation",
        source: "boardroom",
      ...
      {
        id: "h2",
        fact: "Morning Daily Brief delivered pre-market — macro overview + key levels",
        source: "data",
      ...
      {
        id: "h3",
        fact: "Cross-desk risk aggregation flagged elevated NQ exposure",
        source: "trade",
  ...
  },
  {
    id: "oracle",
    label: "Oracle",
    role: "All-Seer — Prediction & Macro",
    accentColor: "#D4AF37",
    memories: [
      {
        id: "o1",
        fact: "Kalshi S&P prediction: 72% probability SPX closes above 5800",
        source: "trade",
      ...
      {
        id: "o2",
        fact: "FOMC dot plot shift — 2 rate cuts priced for 2026 vs 3 prior",
        source: "twitter",
  ...
  },
  {
    id: "feucht",
    label: "Feucht",
    role: "Risk Desk — Futures Execution",
    accentColor: "#D4AF37",
    memories: [
      {
        id: "f1",
        fact: "/NQ morning flush model triggered — watching 20450 for entry",
        source: "trade",
  ...
  },
  {
    id: "consul",
    label: "Consul",
    role: "Fundamentals — Earnings & Thesis",
    accentColor: "#D4AF37",
    memories: [
      {
        id: "c1",
        fact: "NVDA earnings beat +12% — raised guidance on AI data center demand",
        source: "data",
  ...
  },
  {
    id: "herald",
    label: "Herald",
    role: "Sentiment — Social & Mood",
    accentColor: "#D4AF37",
    memories: [
      {
        id: "he1",
        fact: "NQ bearish skew 62% — put/call ratio elevated at 1.4",
        source: "twitter",
      ...
      {
        id: "he2",
        fact: "AAII survey: extreme bearish (48%) — contrarian bullish signal",
        source: "data",
...
const CONNECTIONS: AgentConnection[] = [
  ...
  },
  {
    ...
    type: "context",
    label: "Macro Overlay",
    detail: "Prediction markets informed by fundamental analysis",
  },
  {
    from: "feucht",
    to: "consul",
...
function NucleusNode({ data }: { data: { commandmentCount: number } }) {
  ...
  return (
    ...
    >
      ...
      <span
        className="text-[8px] mt-1 opacity-40"
        style={{ color: "#c79f4a", fontFamily: "var(--font-mono)" }}
      >
        ...
        <div className="mt-2 max-h-[180px] overflow-y-auto px-3 text-left">
          {COMMANDMENTS.slice(0, 5).map((c) => (
            ...
            >
              <span
                style={{
                  color: c.blockLevel === "hard" ? "#EF4444" : "#c79f4a",
                }}
              >
                C{c.number}:
              </span>{" "}
          ...
          <p className="text-[7px] opacity-30" style={{ color: "#c79f4a" }}>
            +{COMMANDMENTS.length - 5} more
          </p>
        </div>
      )}
    </div>
  ...
  return (
    <div
      ...
      style={{
        ...
        animation: isActive
          ? "agentGlow 2s ease-in-out infinite alternate"
          : undefined,
      }}
    >
      {/* Header */}
          ...
          {data.memories.map((mem) => (
            <div
              ...
              style={{
                ...
                backgroundColor: `${data.accentColor}05`,
              }}
            >
              <p
  ...
  const edges: Edge[] = CONNECTIONS.map((conn) => {
    ...
    return {
      ...
      markerEnd: {
        ...
        color: isConflict ? "#EF444440" : "#c79f4a30",
      },
    };
  });
