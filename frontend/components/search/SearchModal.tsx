...
export function SearchModal({
  ...
  return (
    ...
    >
      ...
      >
        {/* Search input */}
        <div className="flex items-center gap-3 border-b border-[var(--fintheon-accent)]/10 px-4 py-3">
          ...
          />
          <kbd className="text-[10px] text-gray-600 border border-gray-700 rounded px-1.5 py-0.5 font-mono">
            esc
          </kbd>
        </div>
          ...
          {results.map((item, idx) => {
            ...
            return (
              ...
              >
                ...
                <span className="text-[9px] uppercase tracking-wider text-gray-600 px-1.5 py-0.5 rounded border border-gray-800">
                  {item.type}
                </span>
              </button>
            );
        ...
        {/* Footer */}
        <div className="border-t border-[var(--fintheon-accent)]/10 px-4 py-2 flex items-center gap-4">
          <span className="text-[10px] text-gray-600 flex items-center gap-1">
            <kbd className="border border-gray-700 rounded px-1 py-0.5 font-mono text-[9px]">
              Tab
            </kbd>{" "}
            to navigate
          </span>
