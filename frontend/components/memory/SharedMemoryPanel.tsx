...
export function SharedMemoryPanel({
  ...
  // the search/filter row doesn't kiss the divider, swapped the hard right
  // border for a Sanctum-style fading vertical ruler, layered the panel as
  // glass over the base, and added a t-fade-in entry transition.
  if (isFileroom) {
    return (
      <div className="flex h-full bg-[var(--fintheon-bg)] t-fade-in">
        {/* Left: Card preview list — glass surface */}
        <div className="fintheon-rail-surface relative flex flex-col w-[420px] min-w-[400px] flex-shrink-0 bg-[var(--fintheon-surface)]/40 backdrop-blur-md">
          ...
          {/* Search + filter — extra right padding so dropdown doesn't touch the ruler */}
