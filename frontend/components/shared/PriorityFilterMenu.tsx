  ...
  return (
    <div className="relative" ref={ref}>
      ...
      <div
        ...
        className={`fintheon-dropdown-surface t-dropdown absolute left-0 top-full mt-1 z-50 min-w-[140px] py-1 bg-zinc-900 border border-zinc-700 rounded shadow-lg ${open ? "is-open" : ""}`}
      >
        <button
          type="button"
          onClick={() => {
