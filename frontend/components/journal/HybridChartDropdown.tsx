...
export function HybridChartDropdown({ mode, onChange }: HybridChartDropdownProps) {
  ...
  return (
    <div className="relative inline-block">
      ...
      >
        {current.label}
        <ChevronDown className={`w-3 h-3 text-[var(--fintheon-muted)] transition-transform ${open ? 'rotate-180' : ''}`} />
      </button>
