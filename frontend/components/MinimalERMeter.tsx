...
export function MinimalERMeter({
  resonance,
  pnl,
  algoEnabled,
}: MinimalERMeterProps) {
    ...
    <div className="flex flex-col gap-2 p-2 bg-[var(--fintheon-surface)] w-full">
      ...
      <div className="flex justify-center">
        <div className="relative h-24 w-4 bg-zinc-900 rounded-full overflow-hidden">
          <div
            className="absolute bottom-0 left-0 right-0 h-0.5 bg-gray-500 z-10"
            style={{ bottom: "50%" }}
          />
          <div
      ...
      <div className="flex flex-col gap-2 items-center pt-1">
        <div className="flex justify-center">
          <div
            className={`w-2 h-2 rounded-full ${algoEnabled ? "bg-emerald-400" : "bg-gray-600"}`}
          />
        </div>
        ...
        <div className="flex flex-col items-center gap-0.5">
          ...
          <span
            className={`text-[10px] font-semibold ${pnl >= 0 ? "text-emerald-400" : "text-red-500"}`}
          >
