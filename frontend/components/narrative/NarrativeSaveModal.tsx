...
export function NarrativeSaveModal({
  open,
  onConfirm,
  onCancel,
}: NarrativeSaveModalProps) {
      ...
      >
        ...
        <div className="p-4">
          <p className="text-sm text-[var(--fintheon-muted)] leading-relaxed">
            Once saved, the previous state cannot be recovered. The agent will
            need to rebuild from context if you need to revert beyond this
            point.
          </p>
        </div>
