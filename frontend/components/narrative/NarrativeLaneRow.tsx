...
export default function NarrativeLaneRow({
  ...
  const handleDrop = useCallback((e: React.DragEvent, col: GridColumn) => {
    if (isReadOnly) return;
    e.preventDefault();
    setDragOverCol(null);
  ...
  return (
    <div
      ...
      style={{
        ...
        borderLeft: severityBorder ? `3px solid ${severityBorder}` : '3px solid transparent',
            ...
            style={{
              ...
              backgroundColor: isToday
                ...
                : isDragTarget
                  ...
                  : undefined,
              outline: isDragTarget ? '1px dashed var(--fintheon-accent)' : undefined,
            ...
            {useAggregates && aggregates ? (
              ...
              (() => {
                ...
                return (
                  ...
                  >
                    <p className="text-[11px] font-semibold truncate" style={{ color: 'var(--fintheon-text)' }}>
                      {agg.title}
                    </p>
                    <div className="flex items-center gap-1.5 mt-1">
                      <span
                        ...
                        style={{
                          color: agg.sentiment === 'bullish' ? 'var(--fintheon-bullish)' : 'var(--fintheon-bearish)',
                          backgroundColor: agg.sentiment === 'bullish'
                      ...
                      <span className="text-[8px] font-mono" style={{ color: 'var(--fintheon-muted)' }}>
