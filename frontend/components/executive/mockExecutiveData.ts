...
export const executiveNeedToKnow: ExecutiveBriefItem[] = [
  ...
  {
    title: "RiskFlow bias: defensive",
    detail: "Reduce duration in rate-sensitive book.",
  },
  {
    title: "Research memo: AI infra pricing",
    detail: "Comp stack suggests margin compression in Q2.",
  },
];
