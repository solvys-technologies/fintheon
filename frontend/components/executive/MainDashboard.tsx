  ...
  const handleInterviewComplete = useCallback(
    (data: {
      ...
      if (data.customRoadblock.trim())
        allRoadblocks.push(data.customRoadblock.trim());
      ...
      settings.setTradingGoals(
        `Daily: $${data.dailyTarget}, Weekly: $${data.weeklyGoal}, Account: $${data.accountSize}`,
      );
      ...
      fetch("/api/blindspots", {
        ...
        body: JSON.stringify({
          blindspots: allRoadblocks.map((rb) => ({
            text: rb,
            severity:
              rb.toLowerCase().includes("overtrad") ||
                  ...
                  <KanbanTitle
                    ...
                    headerRight={
                      <div className="flex items-center gap-1">
                        ...
                        >
                          <RefreshCw
                            className={`w-3 h-3 ${ntnRefreshing ? "animate-spin" : ""}`}
                          />
                        </button>
                      </div>
                    }
