...
export function SessionsDropdown({ onClose, onSelectSession, onNewSession, currentConversationId }: SessionsDropdownProps) {
  ...
  return (
    ...
    >
      ...
      {/* Session list */}
      <div className="overflow-y-auto" style={{ maxHeight: '290px', scrollbarWidth: 'thin' }}>
        {loading && (
      ...
      <div
        ...
        style={{
          ...
          backgroundColor: 'color-mix(in srgb, #0a0a08 95%, var(--fintheon-accent) 5%)',
        }}
      >
