...
const PROVIDERS: { id: HarperProvider; label: string; sub: string; icon: typeof Cpu }[] = [
...
export function ProviderDropdown({ provider, onChange, compact }: ProviderDropdownProps) {
  ...
  return (
    <div ref={ref} className="relative">
      ...
      >
        ...
        <span className="text-[10px] font-medium text-[var(--fintheon-text)]/60">{current.label}</span>
      </button>
