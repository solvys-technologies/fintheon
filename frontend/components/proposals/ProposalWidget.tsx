        ...
        <div>
          ...
          {loading ? (
            <div className="flex items-center justify-center py-12">
              <Loader2 className="w-5 h-5 text-[#c79f4a]/40 animate-spin" />
            </div>
          ) : !proposal ? (
            <div className="border border-[#c79f4a]/15 rounded-lg p-6 text-center">
              <AlertTriangle className="w-5 h-5 text-[#c79f4a]/40 mx-auto mb-2" />
              <div className="text-[11px] text-[#f0ead6]/40">No active proposals</div>
              <div className="text-[10px] text-[#f0ead6]/30 mt-1">
            ...
            <div className="border border-[var(--fintheon-accent)]/30 rounded-lg bg-[var(--fintheon-surface)] overflow-hidden">
              {/* Proposal header row */}
              <div className="flex items-center justify-between px-4 py-3 border-b border-[#c79f4a]/10">
                    ...
                    className={`text-[10px] px-1.5 py-0.5 rounded border font-semibold ${
                      isLong
                        ...
                        : isShort
                          ...
                          : 'text-[#f0ead6]/40 bg-[#f0ead6]/5 border-[#f0ead6]/15'
                    }`}
                  >
              ...
              {/* Trade levels grid */}
              <div className="grid grid-cols-3 divide-x divide-[#c79f4a]/10 border-b border-[#c79f4a]/10">
                <div className="px-3 py-2">
                  <div className="text-[9px] text-[#f0ead6]/30 uppercase">Entry</div>
                  <div className="text-[12px] font-mono text-[#f0ead6]">
                    {proposal.entryPrice?.toFixed(2) || 'Market'}
                  </div>
                </div>
                <div className="px-3 py-2">
                  <div className="text-[9px] text-[#f0ead6]/30 uppercase">Stop</div>
                  <div className="text-[12px] font-mono text-red-400">
                    {proposal.stopLoss?.toFixed(2) || 'N/A'}
                  </div>
                </div>
                <div className="px-3 py-2">
                  <div className="text-[9px] text-[#f0ead6]/30 uppercase">Target</div>
              ...
              <div className="px-4 py-3 space-y-2">
                <div className="text-[10px] text-[#f0ead6]/40">
                  <span className="text-[#f0ead6]/30">Strategy:</span>{' '}
                  {STRATEGY_LABELS[proposal.strategyName] || proposal.strategyName}
                </div>
                <p className="text-[10px] text-[#f0ead6]/40 leading-relaxed line-clamp-3">
                  {proposal.rationale}
                </p>
              </div>
              ...
              <div className="px-4 pb-3">
                ...
                {chartStatus && (
                  <div className="text-[9px] text-[#f0ead6]/30 text-center mt-1.5">{chartStatus}</div>
                )}
              </div>
            </div>
          )}
