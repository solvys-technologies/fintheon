...
export const SKILL_PREFIXES: Record<string, string> = {
  ...
  report: '[SKILL:REPORT] Generate an HTML dashboard report. Use the Solvys Gold palette (#D4AF37 accent, #050402 bg, #f0ead6 text). The report should be self-contained HTML with <!-- FINTHEON_REPORT --> as the first comment. Include inline CSS. Make it visually polished.',
