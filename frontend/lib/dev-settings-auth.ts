...
const DEV_PASSWORD_HASH = 'aea2cc6e020ed4b32498fb2683a5543b3efce8191ce85a33641f5a64a9fb0854';
...
export function isDevAuthenticated(): boolean {
  return localStorage.getItem(LS_KEY) === 'true' && sessionStorage.getItem(SS_KEY) === 'true';
}
