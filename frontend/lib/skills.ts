...
export const SKILLS: readonly SkillDef[] = [
  ...
  { id: 'quick_pulse', label: 'QuickFintheon', icon: Activity, color: 'var(--fintheon-accent)', description: 'Chart screenshot analysis: bias, entries, stop, target', keywords: ['quick', 'fintheon', 'chart', 'screenshot', 'snap'], mcpServers: ['playwright'] },
