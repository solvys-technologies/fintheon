...
export const SKILLS: readonly SkillDef[] = [
  ...
  { id: 'quick_fintheon', label: 'QuickFintheon', icon: Activity, color: 'var(--fintheon-accent)', description: 'Chart screenshot analysis: bias, entries, stop, target', keywords: ['quick', 'fintheon', 'chart', 'screenshot', 'snap'], mcpServers: ['playwright'] },
  ...
  { id: 'update_fintheon', label: 'Update Fintheon', icon: RefreshCw, color: '#38BDF8', description: 'Pull latest changes from repository and rebuild the app', keywords: ['update', 'pull', 'deploy', 'rebuild', 'upgrade'], mcpServers: [] },
] as const;
